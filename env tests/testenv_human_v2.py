...
def main():
    ...
    while running:
        ...
        current_action = None  # Reset action for new episode
        ...
        while not (terminated or truncated) and running:
            ...
            # Use current action or default action
            if current_action is not None:
                action = current_action
            else:
                # Default action: center of map (0, 0 in game coords = 0, 0 in action space)
