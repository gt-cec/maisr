...
class MAISREnvVec(gym.Env):
    ...
    def step(self, actions:dict):
        ...
        if self.terminated or self.truncated:
            print(f'\n Round complete, reward {info['episode']['r']}, timesteps {info['episode']['l']}, score {self.score} | {self.low_quality_identified} low quality | {self.high_quality_identified} high quality | {self.detections} detections | {round(self.time_limit-self.display_time/1000,1)} secs left')
