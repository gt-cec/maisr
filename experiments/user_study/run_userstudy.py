...
from experiments.user_study.rl_data_logger import ExperimentDataLogger
from experiments.user_study.instructional_screens import ScreenManager, WorkloadSurveyScreen, TeammatePreferenceSurveyScreen, \
...
def draw_countdown_overlay(window, font, countdown_steps, countdown_length, map_rect=None):
    ...
    big_font = pygame.font.Font('assets/AcPlus_IBM_VGA_8x16.ttf', 100)
...
def draw_bottom_bar_info(window, font, threats_identified, targets_identified, detections,
    ...
    big_font = pygame.font.Font('assets/AcPlus_IBM_VGA_8x16.ttf', 40)  # Bigger font
    ...
    if high_value_targets > 2:
        warning_font = pygame.font.Font('assets/AcPlus_IBM_VGA_8x16.ttf', 28)
...
def main(subject_id=None, start_level=0, skip_instructions=None,collect_solo_trajectories=False, admin=False, run_third_agent = False, short_rounds = False):
    ...
    agent_models = {
        ...
        'C': f'./exp2_user_study/saved_agents/{agent_c_name}_model.zip',
        'S': f'./exp2_user_study/saved_agents/{agent_s_name}_model.zip', # Solo
        'P': f'./exp2_user_study/saved_agents/{agent_p_name}_model.zip' # Practice
    }
    ...
    vecnorm_paths = {
        ...
        'C': f'./exp2_user_study/saved_agents/{agent_c_name}_vecnormalize.pkl',
        'S': f'./exp2_user_study/saved_agents/{agent_s_name}_vecnormalize.pkl',
        'P': f'./exp2_user_study/saved_agents/{agent_p_name}_vecnormalize.pkl'
    }
    ...
    font = pygame.font.Font('assets/AcPlus_IBM_VGA_8x16.ttf', 26)  # pygame.font.SysFont('Arial', 36, bold=True)
    ...
    try:
        if (not skip_instructions) and start_level == 0:
            ...
            instruction_manager = InstructionSeriesManager(
                window,
                clock,
                map_image_path="assets/map_image.png",
                sensor_image_path="assets/sensor_image.png",
                hvt_video_path="assets/target_id_video.mp4",
                detection_video_path="assets/detection_video.mp4",
                click_video_path="assets/click_control.mp4", # TODO replace
                human_image_path="assets/human_aircraft.png",
                teammate_image_path="assets/teammates_image.png",
                sio = sockets
            )
