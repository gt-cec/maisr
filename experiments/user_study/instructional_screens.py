...
class InstructionalScreen:
    ...
    def __init__(self, window_width: int = 1000, window_height: int = 1100, sio = None, admin=False):
        ...
        font_path = './exp2_user_study/assets/AcPlus_IBM_VGA_8x16.ttf'
        #font_size = 16
...
#             y_pos += 35
#
#         # TODO add video loaded from /assets/detection_video.mp4
#
    ...
    def __init__(self, window: pygame.Surface, clock: pygame.time.Clock,
        ...
        self.screens = [
            ...
            Instruct2Screen(map_image_path or "map_image.jpg", 2, total_screens, window.get_width(),
                            window.get_height()),
            Instruct3Screen(human_image_path, click_video_path or "assets/click_control.mp4", 3, total_screens,
                            window.get_width(), window.get_height()),
            Instruct5Screen(sensor_image_path or "sensor_image.jpg", 4, total_screens, window.get_width(),
                            window.get_height()),
            Instruct6Screen(hvt_video_path or "assets/target_id_video.mp4", 5, total_screens, window.get_width(),
                            window.get_height()),
            Instruct7Screen(detection_video_path or "assets/detection_video.mp4", 6, total_screens, window.get_width(),
                            window.get_height()),
