class UserAircraft {
    constructor(name, startX, startY, path) {
        this.x = startX;
        this.y = startY;
        this.path = path;
    ...
    draw(ctx, Astarpath, aircraftVector) {
        ...
        /* User Aircraft */
        ctx.fillStyle = this.name == "aircraft 1" ? "orange" : "blue"
        ...
        /* Visuals */
        ctx.strokeStyle = this.name == "aircraft 1" ? "orange" : "blue"
    ...
    move(aircraftVector, aircraftVectorX, aircraftVectorY, prevAircraftVector) {
        let out = this.path.getDirection(this.x, this.y, aircraftVector, aircraftVectorX, aircraftVectorY, prevAircraftVector, this.name);
        this.rotation = out[0]
        aircraftVector = out[1]
