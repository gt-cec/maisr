class TargetShip {
    constructor(startX, startY, speed, id, targetClass, threatClass) {
        ...
        this.prevRangeType1 = 0;
        this.prevRangeType2 = 0;
    ...
    draw(ctx, aircraft1, aircraft2) {
        // Get the range
        let rangeType1 = aircraft1.getRangeType(this)
        let rangeType2 = aircraft2.getRangeType(this)
        ...
        if (rangeType1 === 1 || rangeType2 === 1 || rangeType1 === 2 || rangeType2 === 2 || this.seenTargetClass) {
            ...
            if ((rangeType1 == 1 || rangeType2 == 1) && !this.seenThreatClass) {
                this.textLines.push(`Threat Class: UKN`)
                this.seenTargetClass = true
            }
            else if (rangeType1 == 2 || rangeType2 == 2) {
        ...
        if (rangeType1 === 1 || rangeType2 === 1) {
            this.seenTargetClass = true;
        }

        if (rangeType1 === 2 || rangeType2 === 2) {
            this.seenTargetClass = true;
            this.seenThreatClass = true;
        }
        ...
        if ((rangeType1 == 2 && this.prevRangeType1 == 1) || (rangeType2 == 2 && this.prevRangeType2 == 1) ){
            this.numClassification++
        }
        // save previous rangeType
        this.prevRangeType1 = rangeType1
        this.prevRangeType2 = rangeType2
    }
