...
class MAISREnvVec(gym.Env):
    ...
    def get_observation(self):
        ...
        if self.obs_type == 'absolute':
            ...
            map_half_size = self.config["gameboard_size"] / 2
            self.observation[0] = (self.agents[self.aircraft_ids[0]].x + map_half_size) / self.config["gameboard_size"]
            self.observation[1] = (self.agents[self.aircraft_ids[0]].y + map_half_size) / self.config["gameboard_size"]
            ...
            target_features[:self.num_targets, 1] = (self.targets[:, 3] + map_half_size) / self.config["gameboard_size"]
            target_features[:self.num_targets, 2] = (self.targets[:, 4] + map_half_size) / self.config["gameboard_size"]
