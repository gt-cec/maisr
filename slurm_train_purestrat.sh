#!/bin/bash
#SBATCH --job-name=maisr_purestrat       # Job name
#SBATCH --account=gts-kf52                # Tracking account
#SBATCH --output=logs/purestrat%j.out    # Standard output log (%j = job ID)
#SBATCH --error=logs/purestrat%j.err     # Standard error log
